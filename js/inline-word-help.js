...
const RU_COMMON_DEFINITIONS = [
  ...
  {
    label: "Подробнее о слове «Устрояет»",
    closeLabel: "Закрыть",
    text: "Cтаринное слово: направляет, устраивает. Здесь: Бог направляет меня по верному пути.",
    pattern: /(^|[^А-Яа-яЁё])(Устрояет|устрояет)/i
  },
  {
  ...
  {
    label: "Подробнее о «начало быть»",
    closeLabel: "Закрыть",
    text: "Начало быть — появилось по воле Господа.",
    pattern: /(^|[^А-Яа-яЁё])(начало быть)(?=$|[^А-Яа-яЁё])/gi
  },
  {
  ...
  },
  {
    ...
    pattern: /(Блаженны|Блажен|блаженны|блаженство|блажен|блаженства)/
  },
  {
